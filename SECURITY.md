...
- **Reporting** – Open a GitHub security advisory (preferred) or email **`labib-x@protonmail.com`** with “Security Vulnerability”; include description, URL/path, reproduction steps, impact, environment info, and optional fix.  
